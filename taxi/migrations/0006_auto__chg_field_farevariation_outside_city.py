...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FareVariation.outside_city'
        db.alter_column('taxi_farevariation', 'outside_city', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'FareVariation.outside_city'
        db.alter_column('taxi_farevariation', 'outside_city', self.gf('django.db.models.fields.CharField')(max_length=255))
